@extends('layouts.app', ['class' => 'login-page', 'page' =>_('Avaliação DIX'), 'contentClass' => 'login-page'])
    ...
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark text-center mb-2">Seja Bem-vindo(a)!</p>
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-left">
                        <h6>
                            <a href="{{ route('register') }}" class="link footer-link">{{ _('Crie sua conta') }}</a>
                        </h6>
                    </div>
